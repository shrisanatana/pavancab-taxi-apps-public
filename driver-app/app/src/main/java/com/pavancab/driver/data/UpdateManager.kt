...
object UpdateManager {
    ...
    private const val PREFS = "pavancab_driver_update_prefs"
    ...
    suspend fun check(context: Context): UpdateInfo? {
        ...
        return try {
            ...
            val info = UpdateInfo(
                ...
                forceUpdate = force,
                message = runCatching { cfg.get("message").asString }.getOrElse { "A new version of PAVANCAB Driver is available." },
